...
def get_tfidf_features():
    ...
    tfidf_transformer = TfidfVectorizer(ngram_range=(1,2), analyzer='word',stop_words='english',max_features=10000)
...
def train_randomforest(train_X, train_Y, test_X, test_Y, estimators):
